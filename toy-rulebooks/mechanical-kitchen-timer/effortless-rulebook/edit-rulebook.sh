...
#
# Refresh your browser after editing mechanical-kitchen-timer-rulebook.json -- the container's
...
RULEBOOK_SELF_UPDATE_PATH="mechanical-kitchen-timer-rulebook.json"

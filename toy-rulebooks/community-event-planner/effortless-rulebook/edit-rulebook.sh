...
#
# Refresh your browser after editing community-event-planner-rulebook.json -- the container's
...
RULEBOOK_SELF_UPDATE_PATH="community-event-planner-rulebook.json"

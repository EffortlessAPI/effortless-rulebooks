...
#
# Refresh your browser after editing wedding-seating-optimizer-rulebook.json -- the container's
...
RULEBOOK_SELF_UPDATE_PATH="wedding-seating-optimizer-rulebook.json"

...
#
# Refresh your browser after editing volunteer-shift-scheduler-rulebook.json -- the container's
...
RULEBOOK_SELF_UPDATE_PATH="volunteer-shift-scheduler-rulebook.json"

...
#
# Refresh your browser after editing therapist-helper-portal-rulebook.json -- the container's
...
RULEBOOK_SELF_UPDATE_PATH="therapist-helper-portal-rulebook.json"

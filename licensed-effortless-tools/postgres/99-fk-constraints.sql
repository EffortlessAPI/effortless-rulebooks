...
-- Client
ALTER TABLE client DROP CONSTRAINT IF EXISTS fk_client_customer;
ALTER TABLE client ADD CONSTRAINT fk_client_customer
  FOREIGN KEY (customer) REFERENCES client (client_id);

...
# The postgres transpiler is defined in effortless.json with
# RelativePath: "/licensed-effortless-tools/postgres". Running
# effortless -buildLocal in that folder will execute just that transpiler.

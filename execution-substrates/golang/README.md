...
func main() {
    ...
    record := &Workflow{
        WorkflowId:  strPtr("onboarding"),
        DisplayName: strPtr("Employee Onboarding"),
        Title:       strPtr("Onboarding Process"),
        // ... other raw fields
    }
    ...
    fmt.Println(*computed.Name)           // "employee-onboarding"
    fmt.Println(*computed.HasMoreThan1Step) // false
}
```

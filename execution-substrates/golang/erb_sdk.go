...
func (tc *Workflow) CalcCountOfPrecedenceClosurePairs() int {
	return (tc.CountAssertedPrecedencePairs + tc.CountInferredPrecedencePairs)
}
...
func (tc *Workflow) CalcCq1Satisfied() bool {
	return (tc.CountOfPrecedenceClosurePairs == ((tc.CountOfNonProposedSteps * (tc.CountOfNonProposedSteps - 1)) / 2))
}
...
func (tc *Workflow) CalcCq4Satisfied() bool {
	return (tc.CountDerivationLinks == (tc.CountWorkflowArtifacts - 1))
}
...
func (tc *Workflow) ComputeAll() *Workflow {
	...
	countOfPrecedenceClosurePairs := (tc.CountAssertedPrecedencePairs + tc.CountInferredPrecedencePairs)
	...
	cq4Satisfied := (tc.CountDerivationLinks == (tc.CountWorkflowArtifacts - 1))
...
func (tc *WorkflowStep) CalcInferredSequencePosition() int {
	return (tc.PrecedingStepCount + 1)
}
...
func (tc *WorkflowStep) CalcExecutingAgentType() string {
	return func() string { if !((tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == "")) { return "HumanAgent" }; return func() string { if !((tc.ExecutingAIAgent == nil || stringVal(tc.ExecutingAIAgent) == "")) { return "AIAgent" }; return func() string { if !((tc.ExecutingAutomatedPipeline == nil || stringVal(tc.ExecutingAutomatedPipeline) == "")) { return "AutomatedPipeline" }; return "" }() }() }()
}
...
func (tc *WorkflowStep) CalcIsExecutedByAI() bool {
	return !((tc.ExecutingAIAgent == nil || stringVal(tc.ExecutingAIAgent) == ""))
}
...
func (tc *WorkflowStep) CalcIsExecutedByHuman() bool {
	return !((tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == ""))
}
...
func (tc *WorkflowStep) CalcIsApprovalGate() bool {
	return !((tc.ApprovalGate == nil || stringVal(tc.ApprovalGate) == ""))
}
...
func (tc *WorkflowStep) CalcApprovalConsistencyViolation() bool {
	return (boolVal(tc.RequiresHumanApproval) && (tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == ""))
}
...
func (tc *WorkflowStep) CalcApprovalIsHumanFilled() bool {
	return func() string { if boolVal(tc.RequiresHumanApproval) { return !((tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == "")) }; return true }()
}
...
func (tc *WorkflowStep) ComputeAll() *WorkflowStep {
	...
	name := strings.ReplaceAll(strings.ToLower(stringVal(tc.DisplayName)), " ", "-")
	inferredSequencePosition := (tc.PrecedingStepCount + 1)
	executingAgentType := func() string { if !((tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == "")) { return "HumanAgent" }; return func() string { if !((tc.ExecutingAIAgent == nil || stringVal(tc.ExecutingAIAgent) == "")) { return "AIAgent" }; return func() string { if !((tc.ExecutingAutomatedPipeline == nil || stringVal(tc.ExecutingAutomatedPipeline) == "")) { return "AutomatedPipeline" }; return "" }() }() }()
	isExecutedByAI := !((tc.ExecutingAIAgent == nil || stringVal(tc.ExecutingAIAgent) == ""))
	isExecutedByHuman := !((tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == ""))
	isApprovalGate := !((tc.ApprovalGate == nil || stringVal(tc.ApprovalGate) == ""))
	approvalConsistencyViolation := (boolVal(tc.RequiresHumanApproval) && (tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == ""))
	approvalIsHumanFilled := func() string { if boolVal(tc.RequiresHumanApproval) { return !((tc.ExecutingHumanAgent == nil || stringVal(tc.ExecutingHumanAgent) == "")) }; return true }()
...
func (tc *ApprovalGate) CalcHasHumanApprover() bool {
	return !((tc.GateApproverHuman == nil || stringVal(tc.GateApproverHuman) == ""))
}
...
func (tc *ApprovalGate) ComputeAll() *ApprovalGate {
	...
	name := strings.ReplaceAll(strings.ToLower(stringVal(tc.DisplayName)), " ", "-")
	hasHumanApprover := !((tc.GateApproverHuman == nil || stringVal(tc.GateApproverHuman) == ""))
...
func (tc *Role) CalcFilledByArmCount() int {
	return ((func() int { if !((tc.FilledByHumanAgent == nil || stringVal(tc.FilledByHumanAgent) == "")) { return 1 }; return 0 }() + func() int { if !((tc.FilledByAIAgent == nil || stringVal(tc.FilledByAIAgent) == "")) { return 1 }; return 0 }()) + func() int { if !((tc.FilledByAutomatedPipeline == nil || stringVal(tc.FilledByAutomatedPipeline) == "")) { return 1 }; return 0 }())
}
...
func (tc *Role) CalcFillerType() string {
	return func() string { if !((tc.FilledByHumanAgent == nil || stringVal(tc.FilledByHumanAgent) == "")) { return "HumanAgent" }; return func() string { if !((tc.FilledByAIAgent == nil || stringVal(tc.FilledByAIAgent) == "")) { return "AIAgent" }; return func() string { if !((tc.FilledByAutomatedPipeline == nil || stringVal(tc.FilledByAutomatedPipeline) == "")) { return "AutomatedPipeline" }; return "" }() }() }()
}
...
func (tc *Role) CalcEscalationViolation() bool {
	return ((tc.FillsApprovalGate != nil && *tc.FillsApprovalGate > 0) && (tc.DelegatesTo == nil || stringVal(tc.DelegatesTo) == ""))
}
...
func (tc *Role) ComputeAll() *Role {
	...
	name := strings.ReplaceAll(strings.ToLower(stringVal(tc.DisplayName)), " ", "-")
	filledByArmCount := ((func() int { if !((tc.FilledByHumanAgent == nil || stringVal(tc.FilledByHumanAgent) == "")) { return 1 }; return 0 }() + func() int { if !((tc.FilledByAIAgent == nil || stringVal(tc.FilledByAIAgent) == "")) { return 1 }; return 0 }()) + func() int { if !((tc.FilledByAutomatedPipeline == nil || stringVal(tc.FilledByAutomatedPipeline) == "")) { return 1 }; return 0 }())
	fillerType := func() string { if !((tc.FilledByHumanAgent == nil || stringVal(tc.FilledByHumanAgent) == "")) { return "HumanAgent" }; return func() string { if !((tc.FilledByAIAgent == nil || stringVal(tc.FilledByAIAgent) == "")) { return "AIAgent" }; return func() string { if !((tc.FilledByAutomatedPipeline == nil || stringVal(tc.FilledByAutomatedPipeline) == "")) { return "AutomatedPipeline" }; return "" }() }() }()
	escalationViolation := ((tc.FillsApprovalGate != nil && *tc.FillsApprovalGate > 0) && (tc.DelegatesTo == nil || stringVal(tc.DelegatesTo) == ""))
...
func (tc *RoleAssignment) CalcName() string {
	return stringVal(tc.Role) + " [" + stringVal(tc.ValidFrom) + " -> " + func() string { if (tc.ValidTo == nil || stringVal(tc.ValidTo) == "") { return "open" }; return tc.ValidTo }() + "]"
}
...
func (tc *RoleAssignment) CalcIsCurrent() bool {
	return (tc.ValidTo == nil || stringVal(tc.ValidTo) == "")
}
...
func (tc *RoleAssignment) CalcRequiresComplianceAudit() bool {
	return (!((tc.PriorFillerType == nil || stringVal(tc.PriorFillerType) == "")) && (stringVal(tc.PriorFillerType) == "AIAgent") && (stringVal(tc.FillerType) == "HumanAgent"))
}
...
func (tc *RoleAssignment) ComputeAll() *RoleAssignment {
	...
	name := stringVal(tc.Role) + " [" + stringVal(tc.ValidFrom) + " -> " + func() string { if (tc.ValidTo == nil || stringVal(tc.ValidTo) == "") { return "open" }; return tc.ValidTo }() + "]"
	fillerType := func() string { if !((tc.FilledByHumanAgent == nil || stringVal(tc.FilledByHumanAgent) == "")) { return "HumanAgent" }; return func() string { if !((tc.FilledByAIAgent == nil || stringVal(tc.FilledByAIAgent) == "")) { return "AIAgent" }; return func() string { if !((tc.FilledByAutomatedPipeline == nil || stringVal(tc.FilledByAutomatedPipeline) == "")) { return "AutomatedPipeline" }; return "" }() }() }()
	isCurrent := (tc.ValidTo == nil || stringVal(tc.ValidTo) == "")
...
func (tc *Dataset) CalcIsConsumed() bool {
	return !((tc.ConsumedBySteps == nil || stringVal(tc.ConsumedBySteps) == ""))
}
...
func (tc *Dataset) ComputeAll() *Dataset {
	...
	isConsumed := !((tc.ConsumedBySteps == nil || stringVal(tc.ConsumedBySteps) == ""))
...
func (tc *WorkflowArtifact) CalcProducingAgentType() string {
	return func() string { if !((tc.AttributedToHumanAgent == nil || stringVal(tc.AttributedToHumanAgent) == "")) { return "HumanAgent" }; return func() string { if !((tc.AttributedToAIAgent == nil || stringVal(tc.AttributedToAIAgent) == "")) { return "AIAgent" }; return func() string { if !((tc.AttributedToAutomatedPipeline == nil || stringVal(tc.AttributedToAutomatedPipeline) == "")) { return "AutomatedPipeline" }; return "" }() }() }()
}
...
func (tc *WorkflowArtifact) CalcHasDerivationParent() bool {
	return !((tc.DerivedFromArtifact == nil || stringVal(tc.DerivedFromArtifact) == ""))
}
...
func (tc *WorkflowArtifact) CalcHasProducingWorkflow() bool {
	return !((tc.ProducedByWorkflow == nil || stringVal(tc.ProducedByWorkflow) == ""))
}
...
func (tc *WorkflowArtifact) ComputeAll() *WorkflowArtifact {
	...
	producingAgentType := func() string { if !((tc.AttributedToHumanAgent == nil || stringVal(tc.AttributedToHumanAgent) == "")) { return "HumanAgent" }; return func() string { if !((tc.AttributedToAIAgent == nil || stringVal(tc.AttributedToAIAgent) == "")) { return "AIAgent" }; return func() string { if !((tc.AttributedToAutomatedPipeline == nil || stringVal(tc.AttributedToAutomatedPipeline) == "")) { return "AutomatedPipeline" }; return "" }() }() }()
	hasDerivationParent := !((tc.DerivedFromArtifact == nil || stringVal(tc.DerivedFromArtifact) == ""))
	hasProducingWorkflow := !((tc.ProducedByWorkflow == nil || stringVal(tc.ProducedByWorkflow) == ""))

...
#
# Refresh your browser after editing ross-style-business-rules-rulebook.json -- the container's
...
RULEBOOK_SELF_UPDATE_PATH="ross-style-business-rules-rulebook.json"

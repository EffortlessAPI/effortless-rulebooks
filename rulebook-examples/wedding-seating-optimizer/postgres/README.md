...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-05-22 18:35:46 UTC
...
Found **4** tables in rulebook
  ...
  - **Users** (5 fields, 3 records)
  - **Tables** (14 fields, 5 records)
  - **Guests** (19 fields, 23 records)
  - **Relationships** (17 fields, 20 records)

Generated **4** table definitions with **20** raw fields (mode=check-add)
Generated **41** calculation functions
Generated **4** views
Enabled RLS on **4** tables
Generated insert statements for **51** records

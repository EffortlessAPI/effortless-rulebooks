...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-05-26 00:58:58 UTC
...
Found **9** tables in rulebook
  ...
  - **WorkflowSteps** (9 fields, 20 records)
  - **ApprovalGates** (5 fields, 11 records)
...
Generated **9** table definitions with **36** raw fields (mode=check-add)
Generated **38** calculation functions
Generated **9** views
Enabled RLS on **9** tables
Generated insert statements for **137** records

...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-05-19 21:48:15 UTC
...
Found **5** tables in rulebook
  ...
  - **Users** (5 fields, 5 records)
  - **Trainers** (8 fields, 2 records)
  - **Clients** (13 fields, 4 records)
  - **Invoices** (23 fields, 5 records)
  - **Sessions** (15 fields, 13 records)

Generated **5** table definitions with **27** raw fields (mode=check-add)
Generated **46** calculation functions
Generated **5** views
Enabled RLS on **5** tables
Generated insert statements for **29** records

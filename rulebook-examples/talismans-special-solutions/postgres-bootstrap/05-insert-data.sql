...
VALUES ('prod-deploy-step-3', 'Legal Compliance Review & Release Authorization', 'production-deployment', 3, 'ntwf-legal-compliance-role', TRUE, 120, '', 'artifact-release-authorization', 'artifact-risk-report', 'ntwf-release-approval-gate', 'prec-3-4', 'prec-2-3') ON CONFLICT (workflow_step_id) DO NOTHING;
...
VALUES ('artifact-risk-report', 'Risk Assessment Report', 'ART-RISK-001', 'type-report', '2026-04-01T00:00:00-05:00', 'prod-deploy-step-2', '', '', '', 'ntwf-risk-ai', '') ON CONFLICT (artifact_id) DO NOTHING;

INSERT INTO workflow_artifacts (artifact_id, title, identifier, artifact_type, created, produced_by_step, required_by_steps, derived_from_artifact, attributed_to_human_agent, attributed_to_ai_agent, attributed_to_automated_pipeline)
VALUES ('artifact-legal-clearance', 'Legal Clearance Certificate', 'ART-LEGAL-001', 'type-decision-record', '2026-04-02T00:00:00-05:00', 'prod-deploy-step-3', '', 'artifact-risk-report', 'ntwf-james-okafor', '', '') ON CONFLICT (artifact_id) DO NOTHING;

INSERT INTO workflow_artifacts (artifact_id, title, identifier, artifact_type, created, produced_by_step, required_by_steps, derived_from_artifact, attributed_to_human_agent, attributed_to_ai_agent, attributed_to_automated_pipeline)
VALUES ('artifact-release-authorization', 'Release Authorization', 'ART-AUTH-001', 'type-decision-record', '2026-04-02T00:00:00-05:00', 'prod-deploy-step-3', '', 'artifact-legal-clearance', 'ntwf-maria-gonzalez', '', '') ON CONFLICT (artifact_id) DO NOTHING;

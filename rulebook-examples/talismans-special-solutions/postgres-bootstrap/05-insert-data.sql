...
VALUES ('cq-1', 1, 'Steps and order', 'What are all the steps in the release process, and in what order do they execute?', 'Workflows', 'CountOfPrecedenceClosurePairs', 'list', '5 steps, ordered 1 -> 2 -> 3 -> 4 -> 5 (10 closure pairs)', 'WorkflowSteps ordered by SequencePosition; the order is the transitive closure of the asserted StepPrecedence edges, materialized as ntwf:precedesStep.', 1, TRUE, 'drop-final-edge') ON CONFLICT (competency_question_id) DO NOTHING;

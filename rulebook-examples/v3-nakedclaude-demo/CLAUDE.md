# V3 Nakedclaude Demo — Effortless Project

## Authoritative Source: `effortless-rulebook/v3-nakedclaude-demo-rulebook.json` is HEAD

For this project, **`effortless-rulebook/v3-nakedclaude-demo-rulebook.json` is the single, authoritative source of truth.** Edit it directly. All other artifacts (Postgres SQL, Python, Go, Excel, OWL, etc.) are mechanically derived from it via `effortless build`.
...
- `effortless-rulebook/v3-nakedclaude-demo-rulebook.json` — The rulebook (SSoT)

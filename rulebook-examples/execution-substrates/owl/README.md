...
for column in rulebook["Workflows"]["schema"]:
    name = column["name"]           # e.g., "Name"
    datatype = column["datatype"]   # e.g., "string"
    formula = column.get("formula") # e.g., "=SUBSTITUTE(LOWER({{DisplayName}})..."

...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-05-26 02:03:34 UTC
...
Found **4** tables in rulebook
  ...
  - **Events** (8 fields, 2 records)
  - **Volunteers** (10 fields, 5 records)
  - **Shifts** (9 fields, 6 records)
  - **Assignments** (7 fields, 10 records)

Generated **4** table definitions with **15** raw fields (mode=check-add)
Generated **27** calculation functions
Generated **4** views
Enabled RLS on **4** tables
Generated insert statements for **23** records

...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-05-26 01:50:06 UTC
...
Found **3** tables in rulebook
  ...
  - **TransactionTypes** (3 fields, 3 records)
  - **Products** (7 fields, 4 records)
  - **Transactions** (11 fields, 10 records)

Generated **3** table definitions with **9** raw fields (mode=check-add)
Generated **13** calculation functions
Generated **3** views
Enabled RLS on **3** tables
Generated insert statements for **17** records

# Product Inventory — Effortless Project

## Authoritative Source: `effortless-rulebook/product-inventory-rulebook.json` is HEAD

For this project, **`effortless-rulebook/product-inventory-rulebook.json` is the single, authoritative source of truth.** Edit it directly. All other artifacts (Postgres SQL, Python, Go, Excel, OWL, etc.) are mechanically derived from it via `effortless build`.
...
### Never silently revert `product-inventory-rulebook.json`
...
- `effortless-rulebook/product-inventory-rulebook.json` — The rulebook (SSoT)

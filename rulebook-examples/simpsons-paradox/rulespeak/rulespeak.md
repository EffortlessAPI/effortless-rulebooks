...
| Discovery Witness Note | Computed as “LatentTypeD=”, followed by the latent type d count, followed by a slash, followed by the type d count, followed by “; SignFlipMaxPurity=”, followed by the sign flip signal purity max, followed by “; stableD=”, followed by the avg pooled gap stable d, followed by “ latentD=”, followed by the avg pooled gap latent d. | _One-line summary of loop-61 empirical discovery findings._ |
...
| **DR-87 Discovery Witness Note** | A model summary's discovery witness note is computed as “LatentTypeD=”, followed by the latent type d count, followed by a slash, followed by the type d count, followed by “; SignFlipMaxPurity=”, followed by the sign flip signal purity max, followed by “; stableD=”, followed by the avg pooled gap stable d, followed by “ latentD=”, followed by the avg pooled gap latent d. |
...
| **DR-122 Pooled Gap Crosses Zero** | A treatment ranking is flagged pooled gap crosses zero if the value of LOOKUP(Study, SweepStudySummary[SweepStudyId], SweepStudySummary[PooledGapCrossesZero]). |
| **DR-123 Sweep Pooled Gap Range** | A treatment ranking's sweep pooled gap range is computed as the value of LOOKUP(Study, SweepStudySummary[SweepStudyId], SweepStudySummary[SweepPooledGapRange]). |
...
| **DR-126 Study Domain** | A treatment ranking's study domain is computed as the value of LOOKUP(Study, Studies[StudyId], Studies[Domain]). |
...
| **ModelSummary.DiscoveryWitnessNote** | formula | `Concat("LatentTypeD=", LatentTypeDCount, "/", TypeDCount, "; SignFlipMaxPurity=", SignFlipSignalPurityMax, "; stableD=", AvgPooledGapStableD, " latentD=", AvgPooledGapLatentD)` |

...
FROM (
  SELECT
    ...
    calc_model_summary_danger_tier_count(t.model_summary_id) AS danger_tier_count,
    calc_model_summary_caution_tier_count(t.model_summary_id) AS caution_tier_count,

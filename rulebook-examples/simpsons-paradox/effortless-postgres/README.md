...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-07-08 07:21:18 UTC
...
Found **35** tables in rulebook
  ...
  - **ModelSummary** (99 fields, 1 records)
...
Generated **304** calculation functions
Generated **35** views
Enabled RLS on **35** tables
Generated insert statements for **7597** records

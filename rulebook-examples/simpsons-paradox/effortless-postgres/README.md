...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-06-27 19:03:21 UTC
...
Found **7** tables in rulebook
  ...
  - **TreatmentRankings** (17 fields, 1 records)

Generated **7** table definitions with **28** raw fields (mode=check-add)
Generated **39** calculation functions
Generated **7** views

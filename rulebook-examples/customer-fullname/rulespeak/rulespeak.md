...
| Initials | Computed as the first 1 character(s) of the first name, followed by a period, followed by the first 1 character(s) of the last name, followed by a period. | _Last letter of first and last name, dot-separated with trailing dot_ |
...
| **DR-2 Initials** | A customer's initials is computed as the first 1 character(s) of the first name, followed by a period, followed by the first 1 character(s) of the last name, followed by a period. |

...
**Schema:** `public`
**Database:** `demo`
**Timestamp:** 2026-05-26 01:43:30 UTC
...
Found **6** tables in rulebook
  ...
  - **DevUsers** (4 fields, 3 records)
  - **Players** (13 fields, 18 records)
  - **Rosters** (9 fields, 6 records)
  - **RosterAssignments** (16 fields, 18 records)
  - **Matchups** (11 fields, 18 records)
  - **Standings** (12 fields, 6 records)

Generated **6** table definitions with **28** raw fields (mode=check-add)

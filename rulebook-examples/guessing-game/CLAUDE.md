# Guessing Game — Effortless Project

## Authoritative Source: `effortless-rulebook/guessing-game-rulebook.json` is HEAD

For this project, **`effortless-rulebook/guessing-game-rulebook.json` is the single, authoritative source of truth.** Edit it directly. All other artifacts (Postgres SQL, Python, Go, Excel, OWL, etc.) are mechanically derived from it via `effortless build`.
...
- `effortless-rulebook/guessing-game-rulebook.json` — The rulebook (SSoT)
